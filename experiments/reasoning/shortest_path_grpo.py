"""
Usage:
    python -m experiments.reasoning.shortest_path_grpo

    # With overrides:
    python -m experiments.reasoning.shortest_path_grpo wandb_name=my_run learning_rate=1e-5
"""
    ...
    return chz.Blueprint(CLIConfig).apply(
        {
            ...
            "group_size": 8,
            "groups_per_batch": 32,
            "loss_fn": "ppo",  # same as importance sampling since fully on-policy

            # Distillation
            "distillation_mode": "none",

            # Logging
            "wandb_project": "shortest_path",
            "wandb_name": "grpo",
        }
    )

"""
Usage:
    python -m experiments.reasoning.binary_matrix_grpo

    # With overrides:
    python -m experiments.reasoning.binary_matrix_grpo wandb_name=my_run learning_rate=1e-5
"""

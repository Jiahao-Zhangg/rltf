"""
Usage:
    python -m experiments.math.dapo_sd_second_turn

    # With overrides:
    python -m experiments.math.dapo_sd_second_turn wandb_name=my_run learning_rate=1e-5
"""
    ...
    return chz.Blueprint(CLIConfig).apply(
        {
            ...
            # Logging
            "wandb_project": "dapo",
            "wandb_name": "self-distillation-second-turn",
        }
    )
